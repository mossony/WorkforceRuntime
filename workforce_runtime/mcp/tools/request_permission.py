...
from workforce_runtime.core.permissions import REQUEST_PERMISSION


def request_permission(runtime: WorkforceRuntime, arguments: dict[str, object]) -> dict[str, object]:
