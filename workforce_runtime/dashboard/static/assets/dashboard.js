  ...
  <main id="main">
    ...
    <div class="wr-scroll" id="main-scroll">
      <div id="main-content">
        ...
        <div class="input-card idle" id="input-card">
          ...
          <div class="input-footer">
            <div class="input-footer-left">
              <span class="input-type-badge new-task-only">
          ...
          <div id="composer-config-panel" class="composer-config-panel" hidden>
            ...
            <div class="composer-config-actions">
              ...
              <button data-action="toggle-debug-config">Open full config</button>
            </div>
          </div>
        </div>
        ...
        <!-- SIMPLE ORG CHART -->
        <section id="simple-org-section" class="simple-only">
